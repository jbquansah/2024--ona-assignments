...
```{r gender-1}
library(gender)
#install_genderdata_1package() # only run this line the first time you use the package, to get data for it
...
```{r race-2}
library(wru)
examiner_raceredrea <- predict_race(voter.file = examiner_surnames, surname.only = TRUE)
